    ...
    <div id="content-wrap">
      ...
      <Collapsible trigger="Encryption in Persistent Memory Survey">
        <p class="project-description">
          ...
          higher endurance/ better performance through various implementations.
          <b>(CPEG853) </b>
        </p>
        <a
          class="btn"
      ...
      <Collapsible trigger="Augmented Reality Navigation App">
        <p class="project-description">
          ...
          calculate the closest blue light on campus with respect to the user's
          location. Feaures like geolocation, acclerometer, and compass are
          displayed based on the user's location and saved to Firebase's
          realtime database. The navigation feature using Mapbox guides the user
          with a series of arrows and checkpoints to the location.
